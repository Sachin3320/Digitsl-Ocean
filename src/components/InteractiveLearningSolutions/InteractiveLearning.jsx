...
const advantages = [
  {
    ...
    description: "Hands-on participation in lessons enhances engagement and understanding.",
    image: activeLearning,
  },
  {
    id: 2,
    title: "Simplified Concepts",
    description: "Visual and interactive tools make even complex topics easy to grasp.",
    image: simplifiedConcepts,
  },
  {
    id: 3,
    title: "Improved Retention",
    description: "Active involvement leads to better memory retention and application.",
    image: improvedRetention,
  },
  {
    id: 4,
    title: "Collaboration",
    description: "Group activities and collaborative tools encourage teamwork and communication skills.",
    image: collaboration,
  },
  {
    id: 5,
    ...
    <div className="w-full bg-gray-100 py-12 px-6">
      ...
      <div className="flex flex-wrap justify-center gap-6 max-w-6xl mx-auto">
        {advantages.map((advantage) => (
          ...
          >
            <img src={advantage.image} alt={advantage.title} className="w-12 h-12 mb-4" />
