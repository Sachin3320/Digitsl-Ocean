...
const WhoWeAre = ({ reverse }) => {
  return (
    <div className="min-h-screen md:min-h-[60vh] flex items-center justify-center bg-white px-6">
      <div
        className={`container mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20 ${
      ...
      >
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4 md:gap-6">
          ...
          <h2 className="text-lg font-semibold text-gray-700">
            Empowering Food Businesses with Education, Strategy, and Sustainable
            Growth.
          </h2>
          <p className="text-neutral-600 text-base md:text-lg">
            We're a hospitality-focused agency dedicated to empowering food
            businesses through education and strategic support. Our mission is
            to help startups thrive in the competitive food industry, providing
