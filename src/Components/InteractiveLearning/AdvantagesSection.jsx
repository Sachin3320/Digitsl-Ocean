      ...
      <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-3/5">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-2">
            ...
            <p className="text-gray-600 text-sm mt-2">
              Interactive tools make lesson delivery more efficient and
              effective.
            </p>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-rotate-2">
            ...
            <p className="text-gray-600 text-sm mt-2">
              Instantly gauge student understanding and adjust your approach as
              needed.
            </p>
            <div className="w-10 border-b-2 border-gray-600 mt-4"></div>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-2">
            ...
            <p className="text-gray-600 text-sm mt-2">
              Automated features such as assessments and interactive quizzes
        ...
        <div className="w-full lg:w-2/5 flex flex-col gap-6">
          ...
          <p className="text-gray-700 text-sm">
            We don’t just provide products; we deliver experiences. Our
            interactive systems are designed with the specific needs of
            educators and trainers in mind, ensuring maximum value,
