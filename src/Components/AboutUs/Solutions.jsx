...
const Solutions = () => {
  return (
    <div className="min-h-[70vh] w-full p-4 md:p-6 rounded-2xl bg-[#faf1f1] flex flex-col">
      <div className="flex  flex-col lg:flex-row-reverse w-full gap-6 md:gap-12 flex-1">
        ...
        <div className="w-full lg:w-2/5 flex flex-col justify-center p-4">
          ...
          <p className="text-sm md:text-lg text-neutral-600 mt-4">
        ...
        <div className="w-full lg:w-3/5 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
          ...
          {/* Image 1 */}
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden h-full 
                          transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-3">
            <img src={AVsolution} alt="AV Solution" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col justify-between h-full
            ...
            <button className="bg-[#21697D] px-4 py-2 text-white rounded-md hover:scale-105 active:scale-95 transition">
              Explore
            </button>
          </div>
          ...
          <div className="bg-gray-300 rounded-lg shadow-lg overflow-hidden h-full 
                          transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-3">
            <img src={expertSol} alt="Expert Solution" className="w-full h-full object-cover" />
          </div>
