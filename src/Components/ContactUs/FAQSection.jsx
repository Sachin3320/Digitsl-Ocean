...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "What is Digital Wiseon?",
      answer: "Digital Wiseon is a platform for...",
    },
    { question: "How can I support you?", answer: "You can support us by..." },
    {
      question: "How can I find nearest location?",
      answer: "You can find our nearest location by...",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white  rounded-lg p-8">
          ...
          <p className="text-gray-600 mb-6">
            Have any questions? We're here to help you out with all the answers
            you need!
          </p>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-300">
              ...
              {openIndex === index && (
                <p className="text-gray-600 pl-6 pb-4">{faq.answer}</p>
              )}
            </div>
          ))}
        </div>
