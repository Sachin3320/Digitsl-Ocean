...
></div>
          ...
          {/* Title & Description */}
          <h1 className="font-bold text-[3vh] md:text-2xl mb-2">What’s on your mind?</h1>
          ...
          <div className="space-y-3 mb-6">
            <p className="flex items-center gap-2"><FaPhoneAlt /> +91 9031215222</p>
            <p className="flex items-center gap-2"><FaEnvelope /> info@digitalwiseon.com</p>
            <p className="flex items-start gap-2"><FaMapMarkerAlt /> 4th Floor, Govind Bhawan, New Dark Bunglow Road, Patna-800001, Bihar, India</p>
          </div>
        ...
        <div className="w-full md:w-[55%] lg:w-[60%] flex-grow p-6 md:p-8">
          <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-[#21697D]">Get in <span className="text-black">Touch</span> </h2>
          <p className='text-sm md:text-base mb-4'>Enim tempor eget pharetra facilisis sed maecenas adipiscing. Eu leo molestie vel, ornare non id blandit netus.</p>
          ...
          <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
            ...
            <textarea 
              ...
              ></textarea>
            <button type="submit" className="bg-[#21697D] text-white py-3 cursor-pointer hover:scale-105 active:scale-95 duration-700 rounded-2xl hover:bg-[#1b5d6c]">
              SEND
            </button>
          </form>
        </div>
